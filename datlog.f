      subroutine datlog(maxtyp1,lp1,lp2,lp3,lp4,lp5)
...
c  jj,jj    9    29   4060     4495        30  4495  4060  9 29
c  kk,kk   10    33   5984     6545        34  6545  5984 10 33
c  ll,ll   11    37   8436     9139        38  9139  8436 11 37
c  mm,mm   12    41  11480    12341        42 12341 11480 12 41
c--------------------------------------------------------------
...
c
      if(maxtyp1.gt.lp4) then
        call message('datlog :','logic arrays too small,lpar4=',lp4,0)
        call message('datlog :','take set of parameters with lpar4=',
     *                maxtyp1,0)
        call message('datlog :',' make this change in TWELINT',0,0)
        call nerror(1,'datlog :',' execution stopped ', 0,0)
      endif
c----------------------------------------------------------------------
c
      ndege(1)=1
...
c
      call izeroit(nmxyz,3*lp2)
      call izeroit(npxyz,3*lp3)
      do 60 nf=1,nfun
      ix=nia(1,nf)
      iy=nia(2,nf)
      iz=nia(3,nf)
