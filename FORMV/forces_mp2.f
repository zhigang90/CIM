...
C  Y  input for CPHF
      call matsub('evir','epsi',nmo+1,ncf)
...
C
      call addtoT1(tmnao,bl(idena),bl(iddt),ncf,my,
     1             lam)
...
C
      ...
      END
C=======moveTsh============================================
      subroutine moveTsh(tao,Tshells,nqd,my,lam,
     1                  mys,las)
      implicit real*8(a-h,o-z)
C
...
C================calca==========================================
     ...
     2                 Tbar,iscs)
      ...
      parameter (half=0.5d0,dblmax=2 147 483 648.0d0)
c
      dblcmp = dblmax*thresh
c
