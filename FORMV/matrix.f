...
c     multiply a matrix from the left by a diagonal
      ...
      if (ltp2) then
        call matmuld(2,bl(iadr1),bl(iadr2),bl(iadr3),ir2,ic2,ic2,ir2,
     1     ladd)
      else
        call matmuld(1,bl(iadr1),bl(iadr2),bl(iadr3),ir2,ic2,ir2,ic2,
     1  ladd)
      end if
      go to 1000
      end if
      ...
      if(ltp1) then
        call matmuld(4,bl(iadr2),bl(iadr1),bl(iadr3),ir1,ic1,ic1,ir1,
     1   ladd)
      else
        call matmuld(3,bl(iadr2),bl(iadr1),bl(iadr3),ir1,ic1,ir1,ic1,
     1   ladd)
      end if
      go to 1000
      end if
