 ...
 *
 *  758920707 slater 51876 L x86_64 pqsmol 3.3-6-T 11/9/07 YdHjZZEgYbEgYZEg
 *    (1)      (2)    (3) (4)  (5)   (6)     (7)     (8)          (9)
 *
...
int day, month, year;
  ...
  if( !var ) {
   ...
   sprintf( line, "%d %s %ld %s %s %s %s-%s%s %d/%d/%.2d", lock, host, (long)(sec*sec)%100000, pqssys, pqsarch, pqsid, pqsver, pqsrev, pqstr, month, day, year );
