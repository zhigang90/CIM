      subroutine shells(inx,iis,jjs,ijcs1,klcs1)
...
c
      ...
      ktype1=ktype
      ltype1=ltype
c the following code sets itype1 to the Cartesian type. For itype
c 1(s) 2(p) 3(l) 4(d) 5(d6) 6(f) 7(f10) 8(g15) 9(h21) 10(i28) 11(g) 12(h) 13(i)
c itype1 is
c 1    2    3    4    4     5    5      6      7       8       6     7     8
...
C************************************************************
      ...
      NSKL=NQK+NQL-1
c--------
c for NMR and GRADIENT derivatives
c
...
c
c for HESSIAN derivatives (second derivatives)
c
